    ...
    <div className="absolute top-3 left-3 z-1000 w-72 bg-[#020617] border border-yellow-400 rounded-lg shadow-lg">
      <div className="flex">
        <input
          ...
          className="flex-1 px-3 py-2 text-sm bg-transparent text-white/90 outline-none"
        />
        <button
          onClick={search}
        ...
        <div className="max-h-48 overflow-auto border-t border-yellow-400">
          {results.map((r) => (
            <div
              ...
              className="px-3 py-2 text-xs cursor-pointer hover:bg-yellow-400/10 text-white/80"
            >
              {r.display_name}
            </div>
          ))}
