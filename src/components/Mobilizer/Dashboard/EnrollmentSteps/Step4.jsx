...
export default function StepLiveCapture({
  ...
  /* ===================== UI ===================== */
  return (
    <div className="grid lg:grid-cols-2 gap-6 text-white/90">
        ...
        {!photo ? (
          <>
            <video
              ...
              autoPlay
              playsInline
              className="w-full h-64 bg-transparent rounded-lg mb-4"
            />
        ...
        {!location ? (
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm space-y-1">
              <p><span className="text-white/60">Latitude:</span> {location.lat}</p>
              <p><span className="text-white/60">Longitude:</span> {location.lng}</p>
              <p>
