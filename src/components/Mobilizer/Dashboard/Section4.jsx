...
export default function Section4() {
  ...
  return (
    <section className="relative mt-6 rounded-2xl p-6
      bg-transparent border border-yellow-400 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-sm text-white/60">Bank Account</p>
            ...
            {!editMode ? (
              ...
              <>
                ...
                <div className="mt-3">
                  ...
                  <input type="file" className="mt-1 text-sm text-white/80" />
                </div>
