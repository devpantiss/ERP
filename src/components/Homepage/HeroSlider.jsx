...
const NextArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-transparent/40 hover:bg-transparent/60 text-white w-10 h-10 rounded-full flex items-center justify-center"
  >
    ❯
  </button>
);
...
const PrevArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-transparent/40 hover:bg-transparent/60 text-white w-10 h-10 rounded-full flex items-center justify-center"
  >
    ❮
  </button>
);
