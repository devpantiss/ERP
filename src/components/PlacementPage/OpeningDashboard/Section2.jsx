...
function MapSkeleton() {
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-transparent z-900">
...
export default function OpeningGeoMapSection() {
  ...
  return (
    <div className="min-h-screen mt-4 bg-transparent text-white">
      ...
      <div className="relative h-[calc(100vh-70px)]">
        ...
        <div className="absolute top-6 right-6 w-[260px] bg-transparent/70 backdrop-blur border border-cyan-900 rounded-xl p-4 z-1000">
        ...
        <div className="absolute bottom-6 left-6 bg-transparent/70 backdrop-blur border border-cyan-900 rounded-lg p-3 text-xs z-1000">
...
function KpiCard({ title, value, icon }) {
  return (
    <div className="bg-transparent/70 backdrop-blur border border-cyan-900 rounded-lg px-4 py-3 flex items-center gap-3 shadow-lg">
