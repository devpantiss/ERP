    ...
    <>
      <section className="grid grid-cols-1 mt-8 p-8 rounded-2xl
        ...
        <div className="bg-[#0f172a] border border-slate-700 rounded-2xl p-6">
          ...
          <div className="relative flex justify-between items-center mb-5">
            ...
            <button
              ...
              className="font-semibold text-white/90 hover:text-emerald-400"
            >
              {months[month]} {year}
            </button>
            ...
            {showPicker && (
              ...
              >
                <select
                  ...
                  className="w-full mb-3 bg-[#0f172a] border border-slate-700 rounded px-2 py-1 text-white/90"
                >
                  {months.map((m, i) => (
                ...
                <select
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded px-2 py-1 text-white/90"
                >
                  {years.map((y) => (
                  ...
                  className={`rounded-full py-2 text-sm font-medium transition
                    ${
                      active
                        ...
                        : "bg-transparent text-slate-500 hover:bg-slate-700"
                    }`}
                >
                  {day}
                </button>
        ...
        <div className="bg-[#0f172a] border border-slate-700 rounded-2xl p-6 text-center">
          ...
          <div className="text-sm text-left space-y-2 text-white/80 mb-6">
          ...
          <button
            ...
            className="mt-4 text-xs text-white/60 hover:text-emerald-400 underline"
          >
