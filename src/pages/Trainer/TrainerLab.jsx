          ...
          return (
            ...
            >
              {done ? (
                ...
                <BookOpen className="mx-auto text-white/60 mb-2" />
              )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {options.map((item) => (
          <button
            ...
            className="p-5 rounded-xl border border-white/[0.08] hover:border-emerald-400 hover:bg-transparent transition text-left"
          >
