...
export default function TrainerProfile() {
  ...
  return (
    <div className="p-8 bg-[#020617] min-h-screen text-white/90">
...
function ProfileHeader({ profile, onEdit }) {
  return (
    <div className="bg-[#020617]/60 border border-white/[0.08] rounded-2xl p-6 backdrop-blur-xl">
...
function StatCard({ icon, label, value }) {
  return (
    <div className="bg-[#020617]/60 border border-white/[0.08] rounded-xl p-4 backdrop-blur-xl">
...
function InfoCard({ title, children }) {
  return (
    <div className="bg-[#020617]/60 border border-white/[0.08] rounded-xl p-6 backdrop-blur-xl">
...
function TotCertificateCard({ certificate }) {
  return (
    <div className="bg-[#020617]/60 border border-white/[0.08] rounded-xl p-6 backdrop-blur-xl mt-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2 text-sm">
          <p><span className="text-white/60">Certificate:</span> {certificate.name}</p>
          <p><span className="text-white/60">Authority:</span> {certificate.authority}</p>
          <p><span className="text-white/60">Issue Date:</span> {certificate.issueDate}</p>
        </div>
