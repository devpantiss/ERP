...
export default function TrainerLiveHostMeet() {
  ...
  return (
    <div className="h-screen bg-transparent text-white flex flex-col">
      ...
      {/* TOP BAR */}
      <div className="flex items-center justify-between px-6 py-3 bg-transparent/40 backdrop-blur border-b border-white/10">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        <div className="relative w-full max-w-5xl aspect-video rounded-2xl overflow-hidden bg-transparent shadow-2xl">
          ...
          {!started && (
            <div className="absolute inset-0 flex items-center justify-center bg-transparent/70">
              <button
      ...
      {started && (
        <div className="flex justify-center pb-6">
          ...
          <div className="flex items-center gap-4 bg-transparent/50 backdrop-blur px-6 py-3 rounded-full border border-white/10 shadow-xl">
