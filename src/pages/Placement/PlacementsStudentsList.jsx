...
export default function CandidatePlacementSheetEnterpriseDark() {
  ...
  return (
    <div className="min-h-screen w-full min-w-0 max-w-full bg-[#0B1120] p-6 text-white/90 space-y-6">
      ...
      <div className="w-full max-w-full bg-[#111827] border border-cyan-900 rounded-xl overflow-hidden shadow-lg">
