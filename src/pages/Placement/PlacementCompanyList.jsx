    ...
    <section className="mt-8 rounded-2xl p-8 bg-[#111827] border border-cyan-500">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <thead className="bg-[#0f172a] text-white/60">
            <tr>
          ...
          <tbody className="divide-y divide-slate-700">
            ...
            {paginatedData.map((c) => (
              <tr key={c.id} className="hover:bg-transparent/60">

                <td className="p-3 text-white/90 font-medium">
                  {c.companyName}
                </td>

                <td className="p-3 text-white/60">{c.segment}</td>
                ...
                <td className="p-3 text-white/80">{c.spoc}</td>

                <td className="p-3 text-white/60">{c.contact}</td>
                ...
                <td className="p-3">
                  ...
                  {c.loi ? (
                    ...
                    <button
                      ...
                      className="text-xs bg-transparent px-2 py-1 rounded"
                    >
                      Generate
                    </button>
                  )}
  ...
  return (
    <div className="flex flex-col">
      ...
      <input
        ...
        className="bg-[#111827] border border-slate-600 px-3 py-2 rounded text-white/90"
      />
    </div>
  );
}
